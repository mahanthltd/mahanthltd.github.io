<script>
  import Durai from '../assets/durai.jpeg';
</script>

<section
  id="team"
  class="dark:bg-solid-darkLighterBg bg-solid-lightgray grid grid-cols-1 lg:grid-cols-2 md:px-5 lg:px-16 defer rounded-br-6xl lg:bg-blocks-three bg-no-repeat bg-contain bg-right rtl:bg-left"
>
  <p
...
<div class="items-start xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
  <div class="flex flex-col items-center pt-8">
    ...
    <div class="text-gray-500 dark:text-gray-400">Technologist</div>
    <div class="text-gray-500 dark:text-gray-400">
      Director - Mahanth Limited
    </div>
    <div class="flex space-x-3 pt-6">
      <a
        ...
        href="mailto:contact@mahanthltd.co.uk"
        ><span class="sr-only">mail</span><svg
      ...
      ><a
        ...
        target="_blank"
        rel="noopener noreferrer"
        href="https://github.com/durairaj"
      ...
      ><a
        ...
        target="_blank"
        rel="noopener noreferrer"
        href="https://twitter.com/_londontrader_"
  ...
  <div class="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
    ...
    <img
      align="left"
      src="https://github-readme-stats.vercel.app/api/top-langs?username=durairaj&show_icons=true&locale=en&include_all_commits=true&hide_border=true"
      alt="durairaj"
    />
    <img
      align="center"
      src="https://github-readme-stats.vercel.app/api?username=durairaj&show_icons=true&locale=en&include_all_commits=true&hide_border=true"
      alt="durairaj"
    />
    <img
      align="center"
