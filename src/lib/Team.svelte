...
<section
  id="team"
  class="dark:bg-solid-darkLighterBg bg-solid-lightgray py-16 grid grid-cols-1 lg:grid-cols-2 md:px-5 lg:px-16 defer rounded-br-6xl lg:bg-blocks-three bg-no-repeat bg-contain bg-right rtl:bg-left"
>
<p
...
Team
  ...
  >
    <div class="flex flex-col items-center pt-8">
      ...
      <div class="text-gray-500 dark:text-gray-400">Director - Mahanth Limited</div>
    ...
    <div class="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
        ...
        ><img
          src="https://github-profile-trophy.vercel.app/?username=durairaj"
          alt="durairaj"
        /></a
      >
      <img
      align="left"
      src="https://github-readme-stats.vercel.app/api/top-langs?username=durairaj&show_icons=true&locale=en&layout=compact"
      alt="durairaj"
    />
    <img
      align="center"
      src="https://github-readme-stats.vercel.app/api?username=durairaj&show_icons=true&locale=en"
      alt="durairaj"
    />
    <img
    align="center"
    src="https://github-readme-streak-stats.herokuapp.com/?user=durairaj&"
    alt="durairaj"
  />
    </div>
  </div>
